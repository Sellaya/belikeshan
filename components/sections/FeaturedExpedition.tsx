...
export default function FeaturedExpedition({ expedition }: FeaturedExpeditionProps) {
  return (
    <section className="relative min-h-dvh flex items-center overflow-hidden">
      ...
      <div className="relative z-10 container-wide w-full py-16 md:py-24 text-white">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          >
            ...
            <p className="text-white/80 text-base sm:text-lg mb-6">{expedition.subtitle}</p>
            <p className="text-white/65 text-sm sm:text-base leading-relaxed mb-8">{expedition.description}</p>
